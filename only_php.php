        ...
        <figure>
          ...
          <?php
             if(isset($_GET['deptId'])){
               ...
               if($count >= 1){
                while($row_dept = mysqli_fetch_array($run)){
                  ?>
                   <ul class="nospace clear">
                      <li class="one_quarter first folder">
                        ...
                        </a> <div class="centered"><?php echo $row_dept['name'] ?></div> 
                      </li>
                      <li class="three_quarter">
                       
                        <table>
                          <tr>
                            <form method="post" action="movement.php?deptId=<?php  echo $deptId ?>">
                              <td>
                                 <div class="modal-body">
                                    <div class="input-group">
                                      ...
                                      <div class=" one_third" style="text-align: center;">
                                        <input type="hidden" name="fridge_id" value="<?php echo $row_dept['id'] ?>" >
                                        <input   class="btn"  type="submit" name="submit1" value="Go" style="width: 50px;"  />
